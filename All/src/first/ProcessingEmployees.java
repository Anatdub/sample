...
public static void main(String[] args)
{
   ...
   Map<String, Long> employeeCountByDepartment =
      list.stream()
          .collect(Collectors.groupingBy(Employee::getDepartment, 
         /* работает и так...  TreeMap::new,*/ Collectors.counting())
        	//	  (s new TreeMap(String, Long>))-> Collectors.counting(s))
        		  );
   ...
   System.out.printf(
      ...
      list.stream()
   //       .mapToDouble((Employee s)->{return s.getSalary();})
      .mapToDouble(Employee::getSalary)
   ...
   System.out.printf("Average of Employees' salaries: %.2f%n",
      list.stream()
     //     .mapToDouble(Employee::getSalary)
          .mapToDouble((Employee s) -> s.getSalary())
          .average()
          .getAsDouble());      
} // end main
